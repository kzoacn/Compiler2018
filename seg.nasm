...
L_86:
	...
	call query
	mov r8 , rax
	mov r9, qword [gbl+8*30]
	mov r10,r9
	add r10,r8
	xor rdx, rdx
	mov rax, r10
	mov r11, qword [gbl+8*32]
	mov rbx, r11
	cdq
	idiv rbx
	mov r12, rdx
...
L_4:
	...
	cmp r8, 0
	je L_5
	mov r8, qword [gbl+8*56]
	mov r9, qword [gbl+8*57]
	mov r10,r8
	imul r10,r9
	mov r11, qword [gbl+8*59]
	mov r12,r10
	add r12,r11
	xor rdx, rdx
	mov rax, r12
	mov r13, qword [gbl+8*32]
	mov rbx, r13
	cdq
	idiv rbx
	mov r14, rdx
...
L_26:
	...
	call build
	mov r8 , rax
	mov r9, qword [rsp+8*167]
	mov r10,1
	mov r11,r9
	add r11,r10
	mov r13, qword [rsp+8*112]
	mov r12,r13
	mov r14,r11
...
L_49:
	...
	idiv rbx
	mov r10, rdx
	mov r12, qword [gbl+8*118]
	mov r11,r12
	mov r13, qword [rsp+8*274]
	mov r14,r13
	add r14,1
	shl r14,4
	add r14,r11
