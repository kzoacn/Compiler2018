...
getString:
        ...
        mov     rbp, rsp
        sub     rsp, 32
        lea     rsi, [rel buff.1826]
        lea     rdi, [rel L_039]
        mov     eax, 0
        call    scanf
        lea     rdi, [rel buff.1826]
        call    strlen
        mov     qword [rbp-10H], rax
        mov     rax, qword [rbp-10H]
        add     rax, 2
...
L_020:  mov     rdx, qword [rbp-8H]
        mov     rax, qword [rbp-18H]
        add     rdx, rax
        mov     rax, qword [rbp-8H]
        lea     rcx, [rax-1H]
        lea     rax, [rel buff.1826]
...
L_029:  mov     rax, qword [rbp-40H]
        ...
        mov     qword [rdx], rax
        add     qword [rbp-20H], 1
L_030:  cmp     qword [rbp-20H], 4
        jle     L_029
        add     qword [rbp-18H], 1
L_031:  cmp     qword [rbp-18H], 3
        jle     L_028
        mov     qword [rbp-18H], 0
        jmp     L_035
