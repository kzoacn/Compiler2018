...
L_44:
	...
	mov qword [gbl+8*7],r13
	mov qword [rsp+8*18],r15
...
L_16:
	...
	mov r8, qword [gbl+8*36]
	mov r9, qword [rsp+8*70]
	mov r10,r8
	add r10,r9
	mov r8,r10
	mov qword [gbl+8*36],r8
