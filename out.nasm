...
L_0:
	...
	add r12,r13
	mov r14, qword [rsp+8*18]
	mov r14,r12
	sub r14,r9
	mov r15, qword [rsp+8*19]
	mov r15,r14
	...
	mov r8, qword [rsp+8*6]
	add r14,r8
	mov qword [rsp+8*3],r15
	mov r15, qword [rsp+8*39]
	mov r15,r14
	mov qword [rsp+8*4],r9
	mov r9, qword [rsp+8*7]
	add r15,r9
