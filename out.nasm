...
L_0:
	...
	mov rbx,  [gbl+8*5]
	mov rdx,rbx
	mov qword [gbl+8*15],rax
	mov rbx,  [gbl+8*6]
	mov rax,rbx
	mov qword [gbl+8*16],rdx
	mov rbx,  [gbl+8*7]
	mov rdx,rbx
	mov qword [gbl+8*17],rax
	mov rbx,  [gbl+8*8]
	mov rax,rbx
	mov qword [gbl+8*18],rdx
	mov rbx,  [gbl+8*9]
	mov rdx,rbx
	mov qword [gbl+8*19],rax
	mov rbx,  [gbl+8*10]
	mov rax,rbx
	mov qword [gbl+8*20],rdx
	mov rbx,  [gbl+8*11]
	mov rdx,rbx
	mov qword [gbl+8*21],rax
	mov rbx,  [gbl+8*12]
	mov rax,rbx
	mov qword [gbl+8*22],rdx
	mov qword [gbl+8*23],rax
	xor rdx, rdx
	mov rax, [gbl+8*1]
	mov rbx, 10000000
	cdq
...
global_init:
	...
	mov rdx,0
	mov rbx,rdx
	mov qword [gbl+8*13],rbx
	mov rdx,0
	mov rbx,rdx
	mov qword [gbl+8*14],rbx
	mov rdx,0
	mov rbx,rdx
	mov qword [gbl+8*15],rbx
	mov rdx,0
	mov rbx,rdx
	mov qword [gbl+8*16],rbx
	mov rdx,0
	mov rbx,rdx
