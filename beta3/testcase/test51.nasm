...
tmpVariableljjztbmezy:
	 db 3,"wo " ,0

tmpVariablejhhmzqdvlw:
	 db 2,"de" ,0

tmpVariablebgjfpkkvtd:
	 db 4,"luo " ,0

tmpVariablexvggedwdjt:
	 db 3,"ha " ,0
