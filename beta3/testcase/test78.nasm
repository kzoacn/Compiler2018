...
find:
	...
	mov r12,r13
	mov r14, qword [gbl+8*53]
	mov r15,0
	mov r14,r15
	mov qword [rsp+8*50],r8
	mov r8, qword [gbl+8*54]
	mov qword [arg+8*0],r9
	mov r9,1
	mov r8,r9
