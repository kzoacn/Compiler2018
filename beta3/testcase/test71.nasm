...
getcount:
	...
	call    address
	mov [rsp+8*2571], rax
	mov r8, qword [rsp+8*2572]
	mov r9, qword [rsp+8*2571]
	mov r8, [r9]
	mov qword [rsp+8*2572],r8
	mov qword [rsp+8*2571],r9
	mov r8, qword [rsp+8*2572]
	mov r8,r8
	mov r9,1
	add r8,r9
