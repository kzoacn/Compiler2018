...
L_1731:
	...
	mov qword [rsp+8*1721],r12
	mov qword rdi,r13
	mov qword [rsp+8*1722],r14
	mov rdi,[rsp+8*1722] 
	add rdi, 1 
	call puts
	mov r9,  [rsp+8*2]
