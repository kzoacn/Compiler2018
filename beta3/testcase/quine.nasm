...
s2:
	...
	mov [rsp+8*2164] , rax
	mov     rsi, [rsp+8*2164]
	mov     rdi, tmpVariable2281
	call    concat
	mov [rsp+8*2165], rax
	mov     rsi, tmpVariable2285
	mov     rdi, [rsp+8*2165]
	call    concat
	mov [rsp+8*2166], rax
	mov rax,[rsp+8*2166]
...
c2:
	...
	mov [rsp+8*2176] , rax
	mov     rsi, [rsp+8*2176]
	mov     rdi, tmpVariable2303
	call    concat
	mov [rsp+8*2177], rax
	mov     rsi, tmpVariable2307
	mov     rdi, [rsp+8*2177]
	call    concat
	mov [rsp+8*2178], rax
	mov rax,[rsp+8*2178]
...
global_init:
	...
	mov qword [gbl+8*2130] ,tmpVariable2323
	mov qword [gbl+8*389] ,tmpVariable2324
	mov qword [gbl+8*2057] ,tmpVariable2325
	mov rax,[rsp+8*2188]
	leave
	ret
