...
L_264:
	...
	sete r13B
	mov qword [rsp+8*4],r8
	mov qword [rsp+8*174],r13
	mov qword [rsp+8*171],r15
	mov r8,  [rsp+8*174]
	cmp r8, 0
	jne L_269
	mov r9,0
