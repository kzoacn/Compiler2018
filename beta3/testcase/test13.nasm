...
global_init:
	...
	mov    rbp, rsp
	sub    rsp, 576
	mov r10, qword [gbl+8*12]
	mov r11,233
	mov r10,r11
	mov qword [gbl+8*12],r10
	mov r10, qword [gbl+8*62]
	mov r11, qword [gbl+8*12]
	mov r10,r11
	mov r12,1
	sub r10,r12
	...
	mov r11, qword [gbl+8*63]
	mov r10,r11
	mov qword [gbl+8*7],r10
	mov qword [gbl+8*63],r11
