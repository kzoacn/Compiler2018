...
L_1235:
	...
	mov r10,38
	mov r9,r10
	mov qword [arg+8*25],r11
	mov r11,36
	mov r10,r11
	mov qword [arg+8*24],r13
	mov r13,34
	mov r11,r13
	...
	mov r9,16
	mov r12,r9
	mov qword [arg+8*14],r10
	mov r10,14
	mov r9,r10
	mov qword [arg+8*13],r11
	mov r11,12
	mov r10,r11
	mov qword [arg+8*12],r13
	mov r13,10
	mov r11,r13
	...
	mov r9,  [rsp+8*42]
	mov r8,r9
	mov qword [arg+8*24],r11
	mov r11,  [rsp+8*40]
	mov r9,r11
	mov qword [arg+8*23],r13
	mov r13,  [rsp+8*38]
	mov r11,r13
	mov qword [arg+8*22],r10
	mov r10,  [rsp+8*36]
	mov r13,r10
	...
	mov r9,  [rsp+8*18]
	mov r8,r9
	mov qword [arg+8*12],r11
	mov r11,  [rsp+8*16]
	mov r9,r11
	mov qword [arg+8*11],r13
	mov r13,  [rsp+8*14]
	mov r11,r13
	mov qword [arg+8*10],r10
	mov r10,  [rsp+8*12]
	mov r13,r10
