...
gcd:
	...
	mov r13, qword [arg+8*18]
	mov r12,r13
	mov qword [rsp+8*54],r14
	mov r15, qword [arg+8*19]
	mov r14,r15
	...
	mov r13, qword [arg+8*26]
	mov r12,r13
	mov qword [rsp+8*62],r14
	mov r15, qword [arg+8*27]
	mov r14,r15
...
L_631:
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*48]
	mov qword [rsp+8*75],r14
	mov r14,r12
	add r14,r13
	mov r15, qword [rsp+8*49]
...
L_634:
	...
	mov r15,46
	mov r8,r15
	mov qword [arg+8*28],r9
	mov r10,44
	mov r9,r10
	mov qword [arg+8*27],r11
	mov r12,42
	mov r11,r12
	mov qword [arg+8*26],r13
	mov r14,40
	mov r13,r14
	mov qword [arg+8*25],r8
	mov r15,38
	mov r8,r15
	mov qword [arg+8*24],r9
	mov r10,36
	mov r9,r10
	...
	mov r15,30
	mov r8,r15
	mov qword [arg+8*20],r9
	mov r10,28
	mov r9,r10
	mov qword [arg+8*19],r11
	mov r12,26
	mov r11,r12
	mov qword [arg+8*18],r13
	mov r14,24
	mov r13,r14
	mov qword [arg+8*17],r8
	mov r15,22
	mov r8,r15
	mov qword [arg+8*16],r9
	mov r10,20
	mov r9,r10
	...
	mov r15,14
	mov r8,r15
	mov qword [arg+8*12],r9
	mov r10,12
	mov r9,r10
	mov qword [arg+8*11],r11
	mov r12,10
	mov r11,r12
	mov qword [arg+8*10],r13
	mov r14,8
	mov r13,r14
	mov qword [arg+8*9],r8
	mov r15,6
	mov r8,r15
	mov qword [arg+8*8],r9
	mov r10,4
	mov r9,r10
	...
	mov r11,r12
	mov qword [arg+8*29],r13
	mov r14, qword [rsp+8*64]
	mov r13,r14
	mov qword [arg+8*28],r15
	mov r15, qword [rsp+8*63]
	mov r8,r15
	mov qword [arg+8*27],r9
	...
	mov r11,r12
	mov qword [arg+8*25],r13
	mov r14, qword [rsp+8*60]
	mov r13,r14
	mov qword [arg+8*24],r8
	mov r15, qword [rsp+8*59]
	mov r8,r15
	mov qword [arg+8*23],r9
	...
	mov r11,r12
	mov qword [arg+8*21],r13
	mov r14, qword [rsp+8*56]
	mov r13,r14
	mov qword [arg+8*20],r8
	mov r15, qword [rsp+8*55]
	mov r8,r15
	mov qword [arg+8*19],r9
	...
	mov r11,r12
	mov qword [arg+8*5],r13
	mov r14, qword [rsp+8*106]
	mov r13,r14
	mov qword [arg+8*4],r8
	mov r15, qword [rsp+8*40]
	mov r8,r15
	mov qword [arg+8*0],r8
	mov qword [arg+8*3],r9
	mov qword [arg+8*2],r11
...
gcd1:
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*118]
	mov qword [rsp+8*143],r14
	mov r14,r12
	add r14,r13
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*122]
	mov qword [rsp+8*147],r14
	mov r14,r12
	add r14,r13
	mov r15, qword [rsp+8*123]
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*126]
	mov qword [rsp+8*151],r14
	mov r14,r12
	add r14,r13
	mov r15, qword [rsp+8*127]
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*130]
	mov qword [rsp+8*155],r14
	mov r14,r12
	add r14,r13
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*134]
	mov qword [rsp+8*159],r14
	mov r14,r12
	add r14,r13
	mov r15, qword [rsp+8*135]
	...
	mov r13,r12
	xor rdx, rdx
	mov qword [rsp+8*167],r14
	mov r14, qword [rsp+8*109]
	mov rax, r14
...
L_636:
	...
	mov r11,r12
	mov qword [arg+8*22],r13
	mov r14, qword [rsp+8*127]
	mov r13,r14
	mov qword [arg+8*21],r8
	mov r15, qword [rsp+8*126]
	mov r8,r15
	mov qword [arg+8*20],r9
	...
	mov r9,r10
	mov qword [arg+8*15],r11
	mov r12, qword [rsp+8*120]
	mov r11,r12
	mov qword [arg+8*14],r13
	mov r14, qword [rsp+8*119]
	mov r13,r14
	mov qword [arg+8*13],r8
	...
	mov r11,r12
	mov qword [arg+8*6],r13
	mov r14, qword [rsp+8*171]
	mov r13,r14
	mov qword [arg+8*5],r8
	mov r15, qword [rsp+8*174]
	mov r8,r15
	mov qword [arg+8*4],r9
...
gcd2:
	...
	mov qword [rsp+8*209],r12
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*185]
	...
	mov r12,r10
	add r12,r11
	mov r13, qword [rsp+8*189]
	mov qword [rsp+8*214],r14
	mov r14,r12
	add r14,r13
	mov r15, qword [rsp+8*190]
	...
	mov r14,r12
	add r14,r13
	mov r15, qword [rsp+8*206]
	mov qword [rsp+8*231],r8
	mov r8,r14
	add r8,r15
	mov r9, qword [rsp+8*207]
	...
	mov r14, qword [rsp+8*176]
	mov rax, r14
	mov r15, qword [rsp+8*177]
	mov rbx, r15
	cdq
	idiv rbx
...
L_638:
	...
	mov r11,r12
	mov qword [arg+8*30],r13
	mov r14, qword [rsp+8*202]
	mov r13,r14
	mov qword [arg+8*29],r15
	mov r15, qword [rsp+8*201]
	mov r8,r15
	mov qword [arg+8*28],r9
	mov r10, qword [rsp+8*200]
	mov r9,r10
	mov qword [arg+8*27],r11
	mov r12, qword [rsp+8*199]
	mov r11,r12
	mov qword [arg+8*26],r13
	mov r14, qword [rsp+8*198]
	mov r13,r14
	mov qword [arg+8*25],r8
	mov r15, qword [rsp+8*197]
	mov r8,r15
	mov qword [arg+8*24],r9
	...
	mov r11,r12
	mov qword [arg+8*22],r13
	mov r14, qword [rsp+8*194]
	mov r13,r14
	mov qword [arg+8*21],r8
	mov r15, qword [rsp+8*193]
	mov r8,r15
	mov qword [arg+8*20],r9
	...
	mov r9,r10
	mov qword [arg+8*15],r11
	mov r12, qword [rsp+8*187]
	mov r11,r12
	mov qword [arg+8*14],r13
	mov r14, qword [rsp+8*186]
	mov r13,r14
	mov qword [arg+8*13],r8
	mov r15, qword [rsp+8*185]
	mov r8,r15
	mov qword [arg+8*12],r9
